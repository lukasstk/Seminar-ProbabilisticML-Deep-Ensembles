...
# ==============================================================
#  1) Daten laden  (klassisches MNIST  +  Fashion-MNIST für OOD)
# ==============================================================
...
# --- OOD-Daten (Fashion-MNIST) -----------------------------------------------
# OOD-Daten exakt laden
...
# ==============================================================
#  3) Evaluation  (In-D, OOD, Ensemble-Größenkurve)
# ==============================================================

# --- Ensemble auf In-Distribution --------------------------------------------
...
for k in range(1, len(ensemble) + 1):
    # --- Mittelung der ersten k Modelle --------------------------------------
